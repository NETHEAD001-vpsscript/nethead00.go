...
var host = "216.107.137.229" // Your remote server IP
var port = "22"
...
// generatePassword creates a random 12-character password
...
// uuid generates a simple random UUID
func uuid() string {
    b := make([]byte, 16)
    _, err := rand.Read(b)
    if err != nil {
...
func main() {
    ...
    for {
        ...
        case "6":
            ...
            // Please customize the command to match your config.json structure
        ...
        case "8":
            pass := readPassword("Enter Trojan password: ")
