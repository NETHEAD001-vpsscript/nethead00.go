...
var (
    host = getEnv("SSH_HOST", "216.107.137.229") // Server IP
...
// readPassword securely reads password input
...
// generatePassword creates a random 12-character string
...
func main() {
    ...
    for {
        ...
        case "6":
            ...
            // Adjust JSON path as per your config
